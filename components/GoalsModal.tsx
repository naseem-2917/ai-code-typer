...
interface GoalsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (wpmGoal: number, accuracyGoal: number) => void;
  currentWpmGoal: number;
  currentAccuracyGoal: number;
}

export const GoalsModal: React.FC<GoalsModalProps> = ({ isOpen, onClose, onSave, currentWpmGoal, currentAccuracyGoal }) => {
