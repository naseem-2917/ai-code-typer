      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full p-2 bg-slate-200 dark:bg-slate-700 dark:text-slate-50 dark:placeholder-slate-400 border border-slate-300 dark:border-slate-500 rounded-md focus:outline-none focus:ring-2 focus:ring-primary-500"
            placeholder="e.g., 15"
          />
        </div>
        <div className="space-y-2">
